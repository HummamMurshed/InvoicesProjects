                    ...
                    <div class="card-body">
                        <div class="invoice-header">
                            ...
                            <div class="billed-from">
                                <h6 class="text-danger">شركة إفتراضية لتحصيل الديون</h6>
                                <p> <span class="text-primary"> العنوان </span>: شارع المدينة <br>
                                    <span class="text-primary"> تلفون: </span>   967770671424 <br>
                                    <span class="text-primary"> إيميل : </span> <a href="https://kshakshly@gmail.com">kshakshly@gmail.com </a> </p>
                            </div><!-- billed-from -->
                        </div><!-- invoice-header -->
                        <div class="row mg-t-20">
                            <div class="col-md">
                                ...
                                <div class="billed-to">
                                    <h6 class="text-danger">تاريخ طباعة الفاتورة :
                                    <span class="text-danger">{{ date('Y-M-D').now() }} </span>
                                    </h6>
                            ...
                            <div class="col-md">
                                ...
                                <p class="invoice-info-row"><span>تاريخ الاصدار</span>
                                    <span>{{ $invoices->inovices_date }}</span></p>
