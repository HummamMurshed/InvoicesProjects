...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <div>
                <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">هُمام مرشد</h2>
                <p class="mg-b-0">  424 671 770 967+</p>
            </div>
        </div>
        <div class="main-dashboard-header-right">
            <button type="button" class="btn btn-primary">{{ \Illuminate\Support\Facades\Date::now('y')}}</button>
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <p class="mb-0 tx-12 text-white op-50">
                        ...
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    ...
                                    {{number_format(\App\Models\Invoices::where('status','مدفوعة جزئيا')->sum('total'),2)}}
