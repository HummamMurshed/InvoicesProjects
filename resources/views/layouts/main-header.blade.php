        ...
        <div class="main-header-right">
            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                                    ...
                                    <div class="main-notification-list Notification-scroll ">
                                        <a class="d-flex p-3 border-bottom"
                                           href="{{ url('InvoicesDetails') }}/{{ $notification->data['id'] }}">
                                            <div class="notifyimg bg-pink text-center d-flex justify-content-center align-items-center">
                                                <i class="la la-file-alt fa-4x text-white text-center"></i>
                                            </div>
                                            <div class="mr-3">
                ...
                <div class="dropdown main-header-message right-toggle">
                    <a class="nav-link pr-0" data-toggle="sidebar-left" data-target=".sidebarleft">
